...
class OneModel(nn.Module):
    ...
    def forward(self, x, s_x, s_y, y_m, y_b, cat_idx=None):
        ...
        # Tile & Cat
        # concat_feat = supp_pro.expand_as(query_feat)
        merge_feat1 = torch.cat([query_feat1, concat_feat, corr_query_mask1], 1)   # 256+256+1
        ...
        # Tile & Cat
        # concat_feat = supp_pro.expand_as(query_feat)
        merge_feat2 = torch.cat([query_feat2, concat_feat, corr_query_mask2], 1)   # 256+256+1
        ...
        # Tile & Cat
        # concat_feat = supp_pro.expand_as(query_feat)
        merge_feat3 = torch.cat([query_feat3, concat_feat, corr_query_mask3], 1)   # 256+256+1
